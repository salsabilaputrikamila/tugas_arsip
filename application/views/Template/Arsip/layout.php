      ...
      <nav class="navbar navbar-expand-lg main-navbar">
        ...
        <!-- <ul class="navbar-nav navbar-right">
          ...
          <?php foreach ($user as $pmj): ?>
            <img src="<?= base_url('asset/upload/user/') . $pmj->foto_profil ?>" 
              alt="image" class="rounded-circle mr-1" style="opacity: .8">
          <?php endforeach?>
            <div class="d-sm-none d-lg-inline-block">Hi, <?php echo
